...
class JointCritic(nn.Module):
    ...
    Output: scalar Q
    """
    def __init__(self, obs_dim, action_dim, n_agents, hidden_sizes=(512,512)):
        super().__init__()
        self.input_dim = n_agents * (obs_dim + action_dim)
        layers = []
        ...
        self.apply(weights_init_)  # 기존 가중치 초기화

    def forward(self, joint_obs, joint_act):
        # joint_obs, joint_act: tensor of shape (B, n_agents*obs_dim) and (B, n_agents*act_dim)
